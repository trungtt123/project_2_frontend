...
const createProductBatchProduct = (payload) => {
  ...
  return axios.post(
    `/product-batch/products?productBatchId=${productBatchId}&productId=${productId}`,
    {
...
const deleteProductBatchProduct = (productBatchId, productId) => {
  return axios.delete(
    `/product-batch?productBatchId=${productBatchId}&productId=${productId}`
  );
};
